...
/**
 * Error view is shown if not authorized or trying to access non existent resource
 */
...
public class InaccessibleErrorView extends VerticalLayout implements View {
    ...
    public void enter(ViewChangeListener.ViewChangeEvent viewChangeEvent) {
        ...
        addComponent(new Button("To Login", c->{
            ...
            else UI.getCurrent().getNavigator().navigateTo(LoginView.VIEW_NAME + "/" + FilterView.VIEW_NAME);
        }));
    }
